...
const HODApprovalModal = ({ request, onApprove, onDeny, onClose }) => {
  ...
  const handleApprove = async () => {
    ...
    try {
      await onApprove(request.id, {
        approvedBy: 'Current HOD', // In real app, this would be the logged-in HOD
  ...
  const handleDenySubmit = async () => {
    ...
    try {
      await onDeny(request.id, {
        deniedBy: 'Current HOD', // In real app, this would be the logged-in HOD
      ...
      >
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-800">
              Asset Relocation Request - HOD Approval
            </h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="bg-green-50 p-6 rounded-md mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium text-green-900">{selectedAssetDetails?.category}</p>
              </div>
              <div>
          ...
          <div className="bg-yellow-50 p-6 rounded-md mb-6">
            <h3 className="text-xl font-semibold text-yellow-900 mb-4">Transport Arrangement</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-yellow-600">Transport Type</p>
                <p className="font-medium text-yellow-900">{request.transportType}</p>
              </div>
              <div>
                <p className="text-sm text-yellow-600">Requested Date</p>
